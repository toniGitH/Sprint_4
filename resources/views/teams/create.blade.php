...
@section('content')
    ...
    <div class="container mx-auto mt-32 md:mt-20">
        ...
        <div class="bg-slate-200 opacity-90 w-5/6 md:w-2/3 mx-auto p-6 flex flex-col justify-center items-center mt-12 gap-y-4 rounded-lg">
            ...
            <form action="{{route('teams.store')}}" method="POST" class="flex flex-col w-3/4 gap-y-6">
                ...
                <button type="submit" class="w-3/4 lg:w-2/3 mx-auto p-2 rounded-md transition-colors duration-300 ease-in-out bg-white hover:bg-green-500 hover:text-white">CREAR EQUIPO</button>
